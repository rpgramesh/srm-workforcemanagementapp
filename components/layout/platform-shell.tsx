  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.18),transparent_22%),radial-gradient(circle_at_top_right,rgba(16,185,129,0.14),transparent_26%),linear-gradient(180deg,#020617_0%,#0f172a_52%,#111827_100%)]">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-6 py-10 lg:px-10 lg:py-14">
        <section className="grid gap-8 rounded-[32px] border border-slate-200 bg-slate-50/70 p-8 shadow-2xl shadow-slate-950/50 backdrop-blur xl:grid-cols-[1.3fr_0.9fr] xl:p-10">
          <div className="space-y-6">
            <div className="inline-flex rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-2 text-[11px] font-medium uppercase tracking-[0.26em] text-blue-700">
            ...
            <div className="max-w-3xl space-y-4">
              ...
              <h1 className="max-w-4xl text-4xl font-semibold tracking-[-0.05em] text-slate-900 md:text-5xl">
          ...
          <div className="grid gap-4">
            {foundationNotes.map((note) => {
              ...
              return (
                <article
                  key={note.title}
                  className="rounded-3xl border border-slate-200 bg-white/5 p-5"
                >
                  <div className="flex items-start gap-4">
                    <div className="rounded-2xl border border-slate-200 bg-white p-3 text-blue-700">
